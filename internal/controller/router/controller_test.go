...
func TestReconciler_StaticBFD(t *testing.T) {
	...
	const address = "169.254.100.1"
	const interface_ext0 = "ext0"
	...
	t.Run("StaticRouter_PassedToBird", func(t *testing.T) {
		...
		router.Spec.Address = address
		router.Spec.Interface = interface_ext0
	...
	t.Run("MixedBGPAndStatic_AllPassedToBird", func(t *testing.T) {
		...
		bgpRouter.Spec.Address = address
		bgpRouter.Spec.Interface = interface_ext0
